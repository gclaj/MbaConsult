# Candidate Strategic Context — Chris Lajeunesse
...
- West Point, Class of 2021, B.S. Engineering Management, GPA **2.77**
  (~2.50 pre-mission / ~3.23 post-mission). West Point engineering GPAs carry a
  known deflation discount — narrows, does not erase, the gap.
- Tests to date: GRE **318** (157V/161Q); Executive Assessment **154**.
  Retest planned end of August. **The retake is the master unlock.**
- No literal "GMAT offsets GPA" mechanism exists — a strong score NEUTRALIZES
  the academic-ability doubt the 2.77 raises. Prioritize the Quant / Data
  Insights sub-score; that is the part doing the offsetting.
- GMAT Focus targets (aim above median, not at it): HBS/Stanford/Wharton
...
- Active security clearance. Young child ("creating the future for tomorrow").
- The moat: clearance + infantry command + hands-on AI credibility that moved
  institutions and policy + French + lived Central-Africa experience —
  credible to both Silicon Valley and DoD/interagency.

## Career direction — TWO LIVE THESES (choose one spine per school)

### Thesis A — Regulated-enterprise AI transformation
- Edge: forcing institutional absorption of AI inside mission-critical,
  high-stakes organizations (financial services, insurance, healthcare,
  pharma, energy/utilities; defense-industrial as one vertical).
- Mapping: brigade → business unit; MDMP → enterprise governance/change
  management; warfighter-in-the-loop → human-in-the-loop compliance.
- Story: "proved AI adoption in the hardest institution on earth → port it to
  regulated commercial enterprises facing the identical problem."
- Paths: forward-deployed AI-outcomes role at an AI-native vendor (Glean
  application live and strategically central) · internal transformation
  leadership at a regulated incumbent (Chief AI Officer track) · AI
  transformation consulting · found/join early.

### Thesis B — U.S. defense economy × African critical minerals × AI
- Seat: the **Africa strategy / external-affairs / market-access track** (the
  "Africa-CEO lineage" at KoBold-type operators), NOT the deal-execution/BD
  track (that seat competes with ex-mining-bankers and under-uses the moat).
- Endgame framing: secure and process the critical-mineral inputs the
  defense/AI economy depends on, breaking Chinese chokepoints. Midstream
  processing/refining is the real value frontier. ("Build chips in Africa" is
  a category error — semiconductors have no African geographic logic.)
- Short-term bridge: post-MBA management consulting — BCG preferred,
  energy/natural-resources or public-sector/defense practice — time-boxed
  2–3 years with a written exit thesis. Alternative direct on-ramp: U.S. DFC.
  Preferred domain-direct doors: DFC, IFC/AfDB, established multi-fund Africa
  PE, mining-major strategy/external-affairs, KoBold-type operators. Avoid
  thin boutiques (two-filter test: verifiable multi-deal track record + named
  institutional backers; clean diligenceable ownership).
- "Why now" macro (verify freshness before citing): U.S.–DRC Strategic
  Partnership Agreement (Dec 2025); Lobito Corridor Phase 2 (2026);
  Project Vault (~$12B strategic reserve, Feb 2026); KoBold Metals as
  category proof (~$3B valuation, Mingomba copper). Always frame Africa
  engagement as mutually beneficial — the neocolonial critique is live.
- MBB-first sequencing: he already owns the domain half; MBB supplies the
...
- Spine pattern: "I turn emerging technology into national advantage at the
  ...
  actually absorb AI" (Thesis A). The MBA bridges the government/security
  world (credible) to the commercial/capital world (not yet).
- EVIDENCE, NOT ASPIRATION: every forward claim pre-paid by a past proof point.
- Open on a SYSTEM-CHANGE story (AI into the Army → branch-level policy
  ripple), not a war story — the claim is "I reshape institutions with
  technology."
- Play the Africa-authenticity card where Thesis B leads: in the region, in
  the language, years before it was strategically hot.
- Faith/mission service is CHARACTER evidence, not theology.
- Never read "advised"; always "drove adoption that produced X."
- Identity guardrail (unresolved): prior essays claimed Hispanic-American
  identity via a Puerto Rican grandfather; profile reads heavily
  French-Canadian and authenticity/coherence is unconfirmed. Do NOT lean on
  Hispanic identity in essays or interviews until Chris confirms it; post-SFFA
  it is a diminished lever regardless. Authentic identity material: veteran,
  builder, Franco-African connection, faith-rooted service.

## Columbia: rejected off the waitlist → Round 1 REAPPLICATION
- CBS benchmarks (Class of 2027): avg GPA 3.6; avg GMAT 734; GRE ~163V/163Q;
  single highest test score only.
- Why the first application stalled — fix ALL of these everywhere:
  1. Academic signals below median on every axis → "can he handle the quant
     core?" doubt. Hard test score is the only hard rebuttal.
  2. Crowded archetype (military + consulting→impact-PE) with the rare
     differentiator (AI/defense-tech leadership) BURIED; resume genericized
     him as "Operations Officer." Lead with the AI system-change story.
  3. Recommender yellow flag: peer-rank recommender over a senior rater; name
     misspelled in an essay. This cycle: senior rater + obsessive proofreading.
  4. Optional essay defended the GPA backward instead of projecting forward.
  5. Identity framing risk (see guardrail).
- Reapplication playbook: re-center on the rare AI/defense-tech work (JRTC
...
- Fit-to-odds tiers (advisor, Class of 2027 data): Tier 1 **Duke Fuqua**
  (GRE/EA both mid-band, 11% military) + **Michigan Ross**; Tier 2 **Darden,
  Tepper** (best AI thematic fit; scrutinizes 161Q), **UCLA Anderson**;
  Tier 3 anchor **Georgetown McDonough** (avg GRE 318 = his score; DC
  defense/DFC ecosystem — strong Thesis B fit); Tier 4 UNC, USC Marshall.
  Reaches (real only with a retake): CBS reapply, Wharton, Kellogg, Booth,
  MIT Sloan, Haas, Tuck, Yale SOM.
- Thesis-fit overlay (Thesis B route logic): overlap winners **Wharton**
  (Lauder French/Africa + Kleinman + deal training — tightest structural fit)
  and **HBS**; Stanford elite for AI/defense-innovation + Seed (Africa) +
  KoBold proximity; Georgetown (DFC/DoD); Columbia (SIPA/energy policy).
  Note: Tuck, Darden, Kellogg are excellent human/consulting fits but THIN for
  the defense-tech/natsec/Africa thesis — if Chris targets them, Thesis A
  travels better.
- **Stanford GSB: house-money app only** (~2–4% as-is; GPA a full point below
  their 3.76 avg and GPA can't be retaken). Apply only with a real reason
  beyond brand (Seed is the legitimate hook), after target-tier apps are
  fully built, with full effort on the bespoke essays.
- Chris's stated preference: Columbia (reapply), Tuck, possibly Wharton —
  final list pends the retake score and the thesis choice.

## Timeline & parallel track
- Now (July): essay + recommender work in parallel with test prep. First
  deliverable: the 150-word system-change opening scene.
- End of August: retest. Mid-to-late September: Round 1 deadlines.
- Job track continues in parallel (Glean / AI-outcomes roles). SJA
